...
const items = [
  { 
    id: 1, 
    name: 'Nukeproof Mega 275 Carbon Pro Bike GX Eagle 2019', 
    description: 'We will pick it up and deliver it after 2:00 p.m.',
    discountPrice: '$2879.99',
    originalPrice: '$4199.99',
    image: 'https://media.chainreactioncycles.com/is/image/ChainReactionCycles/prod183323_Overcast%20Blue_NE_01?wid=960&hei=498',
    gender: 'Unisex',
    material: 'Carbon',
    speed: '12 Speed'
  },
  { 
    ...
    image: 'https://media.chainreactioncycles.com/is/image/ChainReactionCycles/prod180003_Concrete%20Grey_NE_01?wid=960&hei=498',
    gender: 'Unisex',
    material: 'Carbon',
    speed: '12 Speed'
  },
  { 
    ...
    originalPrice: '$3699.99',
    image: 'https://media.chainreactioncycles.com/is/image/ChainReactionCycles/prod183331_Matt%20Grey_NE_01?wid=960&hei=498',
    gender: 'Unisex',
    material: 'Carbon',
    speed: '12 Speed'
  },
  { 
    ...
    originalPrice: '$5199.99',
    image: 'https://media.chainreactioncycles.com/is/image/ChainReactionCycles/prod182128_Ron%20Burgundy_NE_01?wid=960&hei=498',
    gender: 'Unisex',
    material: 'Carbon',
    speed: '12 Speed'
  },
        ...
        {isLargePhoto 
          ...
          <CatalogCardsItem key={item.id} image={item.image}>
            ...
            <View style={styles.buttonStyles}>
              <BuyButton onPress={() => props.navigation.push('Cart', { ...item })} text={I18n.t("buy")} />
              <DetailsButton onPress={() => props.navigation.push('CatalogCardDetails', { ...item })} text={I18n.t("more_details")} />
            </View>
          </CatalogCardsItem>
          ))
        :
        items.map(item => (
          <GridCatalogCardsItem key={item.id} image={item.image}>
